...
import { GetIssueCommentsHandler } from './get-issue-comments.handler';
import { jiraApiMocks, mockHttp } from '../../../../test/utils/mock-helpers';
import { setupTests } from '../../../../test/utils/test-setup';
import type { JiraClient } from '../../api/jira.client.impl';
import type { Comment, CommentsResult, GetCommentsOptions } from '../../api/jira.models.types';
...
describe('GetIssueCommentsHandler', () => {
  ...
  beforeEach(() => {
    ...
    mockClient = {
      getIssueComments: async (issueKey: string, _options?: GetCommentsOptions) => {
  ...
  describe('successful comment retrieval', () => {
    test('should format single comment correctly', async () => {
      ...
      mockHttp.mockJiraApiSuccess('/rest/api/3/issue/TEST-123/comment', mockResponse);
    ...
    test('should format multiple comments correctly', async () => {
      ...
      mockHttp.mockJiraApiSuccess('/rest/api/3/issue/TEST-456/comment', mockResponse);

      const result = await handler.handle({ issueKey: 'TEST-456' }) as McpResponse<string>;
    ...
    test('should handle empty comments array', async () => {
      ...
      mockHttp.mockJiraApiSuccess('/rest/api/3/issue/EMPTY-1/comment', mockResponse);

      const result = await handler.handle({ issueKey: 'EMPTY-1' }) as McpResponse<string>;
    ...
    test('should respect maxComments parameter', async () => {
      ...
      mockHttp.mockJiraApiSuccess('/rest/api/3/issue/TEST-789/comment', mockResponse);
    ...
    test('should handle orderBy parameter', async () => {
      ...
      mockHttp.mockJiraApiSuccess('/rest/api/3/issue/ORDER-1/comment', mockResponse);
    ...
    test('should filter by author when authorFilter provided', async () => {
      ...
      mockHttp.mockJiraApiSuccess('/rest/api/3/issue/FILTER-1/comment', mockResponse);
    ...
    test('should filter by date range when dateRange provided', async () => {
      ...
      mockHttp.mockJiraApiSuccess('/rest/api/3/issue/DATE-1/comment', mockResponse);
    ...
    test('should filter internal comments when includeInternal is false', async () => {
      ...
      mockHttp.mockJiraApiSuccess('/rest/api/3/issue/INTERNAL-1/comment', mockResponse);
    ...
    test('should include internal comments when includeInternal is true', async () => {
      ...
      mockHttp.mockJiraApiSuccess('/rest/api/3/issue/INTERNAL-2/comment', mockResponse);
  ...
  describe('error handling', () => {
    test('should handle issue not found error', async () => {
      mockHttp.mockJiraApiError('/rest/api/3/issue/NONEXIST-1/comment', 404, 'Issue not found');
    ...
    test('should handle authentication error', async () => {
      mockHttp.mockJiraApiError('/rest/api/3/issue/TEST-1/comment', 401, 'Authentication failed');
    ...
    test('should handle permission error', async () => {
      mockHttp.mockJiraApiError('/rest/api/3/issue/RESTRICT-1/comment', 403, 'Forbidden');
    ...
    test('should handle missing client error', async () => {
      ...
      const result = await handlerWithoutClient.handle({ issueKey: 'TEST-123' });
    ...
    test('should handle malformed response gracefully', async () => {
      ...
      const malformedClient: Partial<JiraClient> = {
        getIssueComments: async () => {
          ...
          throw new Error('Failed to parse API response: comments property is not an array');
        }
      };
      
      const handlerWithMalformedClient = new GetIssueCommentsHandler(malformedClient as JiraClient);

      const result = await handlerWithMalformedClient.handle({ issueKey: 'MALFORM-1' });
  ...
  describe('advanced filtering edge cases', () => {
    test('should handle combined filters correctly', async () => {
      ...
      mockHttp.mockJiraApiSuccess('/rest/api/3/issue/COMBINED-1/comment', mockResponse);
    ...
    test('should handle email-based author filtering', async () => {
      ...
      mockHttp.mockJiraApiSuccess('/rest/api/3/issue/EMAIL-1/comment', mockResponse);
