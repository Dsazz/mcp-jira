...
import { CommentsFormatter, type CommentsContext } from './comments.formatter';
import { setupTests } from '../../../test/utils/test-setup';
import type { Comment } from '../api/jira.models.types';
import type { ADFDocument } from '../utils/adf-parser';
...
describe('CommentsFormatter', () => {
  ...
  describe('format method', () => {
    ...
    test('should show navigation help for truncated comments', () => {
      ...
      expect(result).toContain('**Navigation:** Use `get_issue_comments TEST-123 maxComments:11` to see 4 more comments.');
    });
