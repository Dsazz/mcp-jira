...
import { IssueListFormatter } from './issue-list.formatter';
...
describe('IssueListFormatter', () => {
  ...
  describe('format method', () => {
    test('should format single issue correctly', () => {
      ...
      expect(result).toContain('| Key | Summary | Status | Priority | Updated |');
      expect(result).toContain('| TEST-123 | Test issue summary | To Do | High | 1/15/2024 |');
    });
    ...
    test('should format multiple issues correctly', () => {
      ...
      expect(result).toContain('| TEST-123 | First issue | To Do | High | 1/15/2024 |');
      expect(result).toContain('| TEST-456 | Second issue | In Progress | Medium | 1/16/2024 |');
    });
    ...
    test('should handle missing summary field', () => {
      ...
      expect(result).toContain('| TEST-123 | No Summary | To Do | High | 1/15/2024 |');
    });
    ...
    test('should handle missing status field', () => {
      ...
      expect(result).toContain('| TEST-123 | Test issue | Unknown | High | 1/15/2024 |');
    });
    ...
    test('should handle missing priority field', () => {
      ...
      expect(result).toContain('| TEST-123 | Test issue | To Do | None | 1/15/2024 |');
    });
    ...
    test('should handle missing updated field', () => {
      ...
      expect(result).toContain('| TEST-123 | Test issue | To Do | High | N/A |');
    });
    ...
    test('should handle null fields object', () => {
      ...
      expect(result).toContain('| TEST-123 | No Summary | Unknown | None | N/A |');
    });
    ...
    test('should handle mixed field availability across issues', () => {
      ...
      expect(result).toContain('| TEST-1 | Complete issue | To Do | High | 1/15/2024 |');
      expect(result).toContain('| TEST-2 | Partial issue | Unknown | None | N/A |');
    });
  });
