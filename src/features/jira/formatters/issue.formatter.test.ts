...
describe('IssueFormatter', () => {
  ...
  describe('format method', () => {
    test('should format complete issue correctly', () => {
      ...
      expect(result).toContain('[View in JIRA](https://company.atlassian.net/browse/TEST-123)');
    });
    ...
    test('should generate correct JIRA link', () => {
      ...
      expect(result).toContain('[View in JIRA](https://mycompany.atlassian.net/browse/TEST-123)');
    });
  ...
  describe('edge cases', () => {
    ...
    test('should handle special characters in summary', () => {
      ...
      expect(result).toContain('# TEST-123: Issue with # hash and * asterisk and [brackets]');
    });
