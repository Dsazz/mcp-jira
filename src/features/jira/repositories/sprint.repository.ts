...
import type { GetSprintsOptions, Sprint, SprintReport } from "./sprint.types";

/**
 * Repository interface for sprint operations and retrieval
 * Clear responsibility: managing sprint data and reports
 */
...
/**
 * Implementation of SprintRepository
 * Extracted from JiraClient god object - sprint operations only
 */
