...
import { ADFToMarkdownParser, parseADF, extractTextFromADF, type ADFNode } from './adf-parser';
...
describe('ADFToMarkdownParser', () => {
  ...
  describe('extractPlainText()', () => {
    ...
    test('should handle string input', () => {
      const result = parser.extractPlainText('Simple string');
...
describe('Exported utility functions', () => {
  test('parseADF should work as standalone function', () => {
    const adf: ADFNode = {
      type: 'paragraph',
  ...
  test('extractTextFromADF should work as standalone function', () => {
    const adf: ADFNode = {
      type: 'paragraph',
  ...
  test('both functions should handle null/undefined', () => {
  ...
  test('both functions should handle string input', () => {
    expect(parseADF('test string')).toBe('test string');
    expect(extractTextFromADF('test string')).toBe('test string');
  });
}); 