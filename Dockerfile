...
RUN git clone https://github.com/Dsazz/mcp-jira . && git checkout e3bedfa2f73954c423b450b56c263b782a9fe451

RUN (bun install) && (bun run build)

CMD ["mcp-proxy","bun","./dist/index.js"]
#["bun install", "bun run build"]
#["node", "./dist/index.js"]
#{"JIRA_HOST": "https://your-instance.atlassian.net", "JIRA_USERNAME": "your-email@domain.com", "JIRA_API_TOKEN": "your-api-token"}